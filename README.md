...
Разработанный продукт имеет клиент-серверную архитектуру: 
- Клиентская часть размещена в папке client. В папке имеется файл README.md с инструкциями по установке зависимостей и запуску.
- Серверная часть разработана для инкапсуляции внешних запросов и размещена в папке server. В папке имеется файл README.md с инструкциями по установке зависимостей и запуску.

Для запуска необходимо скачать Node.js: https://nodejs.org/en/download/
